...
<head>
	...
	<title>Coming Soon Testings</title>
	...
	<link rel="stylesheet" href="<?= base_url() ?>assets/admin/vendor_assets/css/fontawesome.css">
	<link rel="stylesheet" href="<?= base_url() ?>assets/admin/vendor_assets/css/footable.standalone.min.css">
	<link rel="stylesheet" href="<?= base_url() ?>assets/admin/vendor_assets/css/fullcalendar@5.2.0.css">
	<link rel="stylesheet" href="<?= base_url() ?>assets/admin/vendor_assets/css/jquery-jvectormap-2.0.5.css">
	<link rel="stylesheet" href="<?= base_url() ?>assets/admin/vendor_assets/css/jquery.mCustomScrollbar.min.css">
	<link rel="stylesheet" href="<?= base_url() ?>assets/admin/vendor_assets/css/leaflet.css">
	<link rel="stylesheet" href="<?= base_url() ?>assets/admin/vendor_assets/css/line-awesome.min.css">
	<link rel="stylesheet" href="<?= base_url() ?>assets/admin/vendor_assets/css/magnific-popup.css">
	<link rel="stylesheet" href="<?= base_url() ?>assets/admin/vendor_assets/css/MarkerCluster.css">
	<link rel="stylesheet" href="<?= base_url() ?>assets/admin/vendor_assets/css/MarkerCluster.Default.css">
	<link rel="stylesheet" href="<?= base_url() ?>assets/admin/vendor_assets/css/select2.min.css">
	<link rel="stylesheet" href="<?= base_url() ?>assets/admin/vendor_assets/css/slick.css">
