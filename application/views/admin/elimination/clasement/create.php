...
<div class="card">
    <?= form_open(route_url('store_clasement'), ['name' => 'form-create', 'id' => 'form-create', 'class' => 'form-horizontal']) ?>
        ...
        <div class="row">
            <div class="col-md-8 offset-md-2">
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="district" id="district" class="form-control" required>
                            ...
                            foreach ($districts as $district) : ?>
                                <option value="<?= $district->id ?>-<?= $district->regional_id ?>"><?= $district->name ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                </div>
                <div class="row mb-3">
                    ...
                    <div class="col-md-8">
                        <label for="code" class="col-form-label">Judul/Title Klasemen</label>
                        <div class="col-md-6 row">
                            <input type="text" name="title" value="" class="form-control" placeholder="Title Klasemen" required>
                        </div>
                    </div>
                </div>
                <div class="row mb-3">
    ...
    $(document).ready(function() { // Ketika halaman sudah siap (sudah selesai di load)
        ...
        $("#district").change(function() { // Ketika user mengganti atau memilih data provinsi
            ...
            $.ajax({
                ...
                url: "<?php echo base_url('admin/eliminations/classement/district_team_list'); ?>", // Isi dengan url/path file php yang dituju
                data: {
