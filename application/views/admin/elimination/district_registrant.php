...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-bordered table-striped table-dheezer" id="datatable" datatable-ajax="<?= site_url('admin/eliminations/district/loadTable') ?>" data-update="<?= route_url('update_status/:id') ?>">
                <thead>
                    <tr>
                        <th>No.</th>
                        <th>Nama Tim</th>
                ...
                "columnDefs": [{
                    ...
                    },
                    {
                        ...
                        "render": function(data, type, row) {
                            ...
                            if ( (row[4]).toUpperCase() === 'DISTRICT QUALIFICATION STAGE' )
                            {
