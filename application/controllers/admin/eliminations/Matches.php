...
class Matches extends DZ_Controller
{
    ...
    public function store()
    {
        if ($this->input->method() == "post") {
            ...
            $match_id = $this->model_match->insert_match($data);
            if($home_team){
                $data_home['match_id'] = $match_id;
                $data_home['futsal_team_id'] = $home_team;
                $result = $this->model_match->insert_match_teams($data_home);
            }
            if($away_team){
                $data_away['match_id'] = $match_id;
                $data_away['futsal_team_id'] = $away_team;
                $result = $this->model_match->insert_match_teams($data_away);
            }
